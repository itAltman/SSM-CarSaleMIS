describe('vsiaulMap_setOption', function() {
    ...
    testCase.createChart()('eraseAllVisualProps_notRelative', function () {
        ...
        // Do not compare com.controller.inRange.symbolSize, which will be amplified to com.controller size.
        // expect(option.visualMap[0].com.controller.inRange.symbolSize).toEqual([?, ?]);
    });
