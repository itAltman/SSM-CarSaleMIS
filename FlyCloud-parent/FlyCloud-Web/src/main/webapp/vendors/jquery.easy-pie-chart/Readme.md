...
```html
<div ng-com.controller="chartCtrl">
...
<script>
    ...
    app.com.controller('chartCtrl', ['$scope', function ($scope) {
        $scope.percent = 65;
        $scope.options = {
            animate:{
                duration:0,
...
For a value binding you need to add the `percent` attribute and bind it to your com.controller.
