...
require('./core/core.com.controller')(Chart);
...
require('./controllers/com.controller.bar')(Chart);
require('./controllers/com.controller.bubble')(Chart);
require('./controllers/com.controller.doughnut')(Chart);
require('./controllers/com.controller.line')(Chart);
require('./controllers/com.controller.polarArea')(Chart);
require('./controllers/com.controller.radar')(Chart);
...
module.exports = function(Chart) {
	...
	// The main com.controller of a chart
	...
	helpers.extend(Chart.Controller.prototype, {
		...
		draw: function(ease) {
			...
			// Draw each dataset via its respective com.controller (reversed to support proper line stacking)
			helpers.each(this.data.datasets, function(dataset, datasetIndex) {
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.legend = {
		...
		onClick: function(e, legendItem) {
			...
			// See com.controller.isDatasetVisible comment
