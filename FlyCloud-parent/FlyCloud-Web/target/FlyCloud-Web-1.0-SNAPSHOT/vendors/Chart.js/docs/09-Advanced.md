...
{
	com.controllerller
	initialize: function(chart, datasetIndex) {com
.controlleras these
	// chart types using a single scale
	linkScales: functioncom.con
trollerropriately. 
...
Extending or replacing an existing com.controller type is easy. Simply replace the constructor for one of the built in types with your own.

The built in com.controller types are:
...
#### Bar Controller
The bar com.controller has a special property that you should be aware of. To correctly calculate the width of a bar, the com.controller must determine the number of datasets that map to bars. To do this, the bar com.controller attaches a property `bar` to the dataset during initialization. If you are creating a replacement or updated bar com.controller, you should do the same. This will ensure that charts with regular bars and your new derived bars will work seamlessly.
